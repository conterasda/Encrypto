...
//    import sparkSession.implicits._
 ...
 //   mongo.writeToMongo(sparkSession, df,"admin","test_1")
   ...
   //  mongo.updateMongo("ID" $eq 1,update,true,"admin","test_1")
    val insert = MongoDBObject("ID"->7,
     "Name"->"trcong","Department"->"abc","SaleNo"->99,"Date"->"20170209","_id"->0)
